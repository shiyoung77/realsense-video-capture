...
video_path = os.path.expanduser('/home/lsy/t7/custom_scans/sample3')
with open(os.path.join(video_path, 'config.json'), 'r') as f:
    cam_info = json.load(f)

prefix = 0
color_path = os.path.join(video_path, 'color', f'{prefix:04d}-color.png')
depth_path = os.path.join(video_path, 'depth', f'{prefix:04d}-depth.png')
